 ...
 */
package com.sinosoft.utility; /* 声明Log类所属类包 */
...
{
	private static String strUserLogFileName = ConfigInfo.GetValuebyName(SysConst.USERLOGPATH);

	// 应用程序日志
	private static String strSysLogFileName = ConfigInfo.GetValuebyName(SysConst.SYSLOGPATH);
	...
	public UserLog()
	{
		...
		{
			strUserLogFileName = strUserLogFileName.substring(0, strUserLogFileName.indexOf(".")) + "(" + strDateYear
					+ "_" + strDateMonth + "_" + strDateDay + ")" + userLogExtendsion;
		}
		...
		{
			strSysLogFileName = strSysLogFileName.substring(0, strSysLogFileName.indexOf(".")) + "(" + strDateYear
					+ "_" + strDateMonth + "_" + strDateDay + ")" + sysLogExtendsion;
		}
	...
	public static int println(String strValue)
	{
		...
		finalstrValue = "<" + StrTool.getDate() + " " + StrTool.getTime() + ">" + strValue + "\n";
	...
	public static int println(int intValue)
	{
		...
		finalstrValue = "<" + StrTool.getDate() + " " + StrTool.getTime() + ">" + intValue + "\n";
		return print(finalstrValue);
	}
	...
	public static int println(double doubleValue)
	{
		...
		finalstrValue = "<" + StrTool.getDate() + " " + StrTool.getTime() + ">" + doubleValue + "\n";
		return print(finalstrValue);
	}
	...
	public static int println(Object object)
	{
		...
		finalstrValue = "<" + StrTool.getDate() + " " + StrTool.getTime() + ">" + object.toString() + "\n";
		return print(finalstrValue);
	}
	...
	{
		String strLog = "<" + StrTool.getDate() + " " + StrTool.getTime() + ">" + strValue + "\n";
		try
		{
