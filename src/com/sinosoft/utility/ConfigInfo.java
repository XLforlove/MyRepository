...
public class ConfigInfo
{
	...
	/***************************************************************************
	 * 构造方法(以Config路径初始化实例) 参数 ：XmlFilePath :Config文件路径 返回值：无
	 * *********************************************************************
	 */
	...
	/***************************************************************************
	 * 得到Config路径字符串 参数 ：无 返回值：Config文件路径
	 * *********************************************************************
	 */
	...
	/***************************************************************************
	 * 设置Config路径字符串 参数 ：XmlFilePath :新Config文件路径 返回值：无
	 * *********************************************************************
	 */
	...
	/***************************************************************************
	 * 通过名称得到字段配置信息 参数：fieldname :配置域名称 返回值：配置信息
	 * *********************************************************************
	 */
	...
	/***************************************************************************
	 * 通过名称范围得到字段配置信息 参数：fieldname :配置域名称值 返回值：配置信息
	 * *********************************************************************
	 */
...
//		int strPos = 0;
	...
	/***************************************************************************
	 * 通过ip得到打印配置信息 参数：inpip :配置域名称值 返回值：配置信息
	 * *********************************************************************
	 */
...
//			int intIndex = 0;
			...
			while ((len = readconfig.read()) != -1)
			{
				...
				{ // 若到行末则将该行转化为string
					...
					tempStr = tempStr.trim();
					// 解析出配置域名
					fieldname = StrTool.decodeStr(tempStr, ".", 1) + "." + StrTool.decodeStr(tempStr, ".", 2); // 解析出配置域名
		...
		{
			String ErrorString = "<Conf.class> Parsing config file error:" + exception.toString();
			UserLog.printException(ErrorString);
		}
...
//		ConfigInfo test = new ConfigInfo();
		System.out.println(ConfigInfo.GetValuebyName(SysConst.USERLOGPATH));
