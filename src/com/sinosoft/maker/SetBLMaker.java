...
public class SetBLMaker
{
	...
	// @Constructor
	public SetBLMaker(String fName)
	{
		FileName = fName;
	}

	public SetBLMaker(String fName, String t)
	{
		FileName = fName;
		TableName = t;
		/*
...
//		JMetaDB mdb = new JMetaDB(sUrl);
	...
	public void create()
	{
		...
		String Path = ".\\com\\sinosoft\\lis\\vbl\\";
		String ClassName = TableName + "BLSet";
		...
		try
		{
			...
			out.println(" * <p>Description: " + SetName + "BL类文件 </p>");
			...
			out.println(" */");
			// @Package
			out.println("package com.sinosoft.lis.vbl;");
			out.println("");
			// @Import
